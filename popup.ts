...
httpClient.getJson('https://www.reddit.com/r/soccerstreams_pl', plResult => {
  ...
  httpClient.getJson('https://www.reddit.com/r/soccerstreams_other', otherResult => {
    ...
    DomHelper.soccerStreamsPlLink.addEventListener('click', () => {
      chrome.tabs.create({ url: 'https://www.reddit.com/r/soccerstreams_pl', active: true });
    }, false);
    DomHelper.soccerStreamsOtherLink.addEventListener('click', () => {
      chrome.tabs.create({ url: 'https://www.reddit.com/r/soccerstreams_other', active: true });
    }, false);
