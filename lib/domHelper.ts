class DomHelper {
  ...
  static searchInput: HTMLInputElement = <HTMLInputElement>(
    document.getElementById('search')
  );
  static matchesTable: HTMLElement = document.getElementById('matches');
  static soccerStreamsLink: HTMLElement = document.getElementById(
    'soccer-streams-link'
  );
  static soccerStreamsLinkWrap: HTMLElement = document.getElementById(
    'soccer-streams-link-wrap'
  );
  static soccerStreamsNote: HTMLElement = document.getElementById(
    'soccer-streams-note'
  );
  ...
  static clipboardTextarea: HTMLTextAreaElement = <HTMLTextAreaElement>(
